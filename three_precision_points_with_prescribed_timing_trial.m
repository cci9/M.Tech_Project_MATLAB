%%%%%%%%% Path Generation Problem with Prescribed Timing %%%%%%%%%%
% Fixed line A0B0
a0x=2;%a0x=input('Enter x coordinate of A0 point=');
a0y=0;%a0y=input('Enter y coordinate of A0 point=');
b0x=7;%b0x=input('Enter x coordinate of B0 point=');
b0y=0;%b0y=input('Enter y coordinate of B0 point=');

% Different Position
p1x=3;%p1x=input('Enter x coordinate of P1 point=');
p1y=5;%p1y=input('Enter y coordinate of P1 point=');

p2x=3.5;%p2x=input('Enter x coordinate of P2 point=');
p2y=5.2;%p2y=input('Enter y coordinate of P2 point=');

p3x=4;%p3x=input('Enter x coordinate of P3 point=');
p3y=5.5;%p3y=input('Enter y coordinate of P3 point=');

% Rotational angle of crank with respect to different position
thetal12=45;%theta12=input('Enter crank rotation angle in degrees when point P1 to point P2');
thetal21=thetal12;
theta21=thetal21*pi/180; %%degree to radian angle 
% disp(theta21);

thetal13=100;%theta13=input('Enter crank rotation angle in degrees when point P1 to point P3');
thetal31=thetal13;
