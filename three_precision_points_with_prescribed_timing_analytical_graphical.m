...
alphal12=-2.3013;%alphal12=input('Enter angle between input link and coupler link in degrees when coupler moves from point P1 to point P2');
alpha12=alphal12*pi/180; %%degree to radian angle 
C=exp(alpha12*1i)-1;
disp(C);

alphal13=-3.4347;%alphal13=input('Enter angle between input link and coupler link in degrees when coupler moves from point P1 to point P3');
alpha13=alphal13*pi/180; %% degree to radian angle
D=exp(alpha13*1i)-1;
disp(D);

% Assumed angle between the output and coupler link for different postion
fil12=-44.9794;%fil12=input('Enter angle between output link and coupler link in degrees when coupler moves from point P1 to point P2');
fi12=fil12*pi/180; %%degree to radian angle
E=exp(fi12*1i)-1;
disp(E);

fil13=-94.8411;%fil13=input('Enter angle between output link and coupler link in degrees when coupler moves from point P1 to point P3');
