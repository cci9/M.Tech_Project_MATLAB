...
% Fixed line A0B0
% Different Position
p1x=-2;%p1x=input('Enter x coordinate of P1 point=');
p1y=8;%p1y=input('Enter y coordinate of P1 point=');

p2x=0;%p2x=input('Enter x coordinate of P2 point=');
p2y=9;%p2y=input('Enter y coordinate of P2 point=');

p3x=3;%p3x=input('Enter x coordinate of P3 point=');
p3y=10;%p3y=input('Enter y coordinate of P3 point=');

p4x=5;%p3x=input('Enter x coordinate of P3 point=');
p4y=11;%p3y=input('Enter y coordinate of P3 point=');

% Rotational angle of crank with respect to different position
thetal12=50;%theta12=input('Enter crank rotation angle in degrees when coupler moves from point P1 to point P2');
thetal21=thetal12;
theta21=thetal21*pi/180; %%degree to radian angle 

thetal13=80;%theta13=input('Enter crank rotation angle in degrees when coupler moves from point P1 to point P3');
thetal31=thetal13;
theta31=thetal31*pi/180; %% degree to radian angle 

thetal14=100;%theta13=input('Enter crank rotation angle in degrees when coupler moves from point P1 to point P4');
thetal41=thetal14;
